package access.denied.meta.activity
...
import access.denied.meta.fragment.*
import access.denied.meta.service.ApplicationsService
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val serviceIsRunning = activityManager.runningAppProcesses.any {
            it.processName == "access.denied.meta.ApplicationsService"
        }
    ...
    private fun enableAdmin() {
        ...
        compName = ComponentName(this, access.denied.meta.utillies.AppAdminReceiver::class.java)
